...
異なる分野での挑戦は、多角的な視点と柔軟な思考力を育んでくれました。これからも様々なことに挑戦し続けていきたいと思います。`
    ...
    {
      id: 4,
      title: "母の選択的夫婦別姓訴訟と私の原点",
      date: "2025年2月10日",
      summary: "社会の不公平に声を上げることの大切さを、母の姿から学んだ経験を振り返ります。",
      content: `私の母は2015年の選択的夫婦別姓訴訟の原告の一人でした。幼い頃から、社会の仕組みに対する矛盾や不平等に対して、主張し行動する母の姿を見て育ちました。

「声をあげることの重要性」を知り、それが自分の「若者の政治離れを解決したい」という問題意識につながりました。社会の不都合に声を上げ、権利を主張することが、どれほど大切かを家庭で学べたことは、私の大きな財産です。

母の姿から、「自分が変えたいと思うなら、自分から行動を起こす」という姿勢を学びました。ミラコエの活動も、この原点があってこそだと思います。

今、私は若者の政治参加という別の課題に取り組んでいますが、根底にある「声をあげる大切さ」は共通しています。これからも、社会をより良くするために行動し続けていきます。`
    },
    {
      id: 5,
